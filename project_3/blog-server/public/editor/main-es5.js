...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"]]]
    });
  ...
  function srcAppBlogServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var BlogService = /*#__PURE__*/function () {
      ...
      _createClass(BlogService, [{
        ...
        key: "newPost",
        value: function newPost(username, postid) {
          var url = "/api/".concat(username, "/").concat(postid);
          var body = {
            title: '',
            body: ''
  ...
  function srcAppEditEditComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function EditComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function EditComponent_div_0_Template_input_input_5_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);

          var ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r1.onTitleChange($event);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function EditComponent_div_0_Template_textarea_input_8_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);

          var ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r3.onBodyChange($event);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditComponent_div_0_Template_button_click_12_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditComponent_div_0_Template_button_click_14_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditComponent_div_0_Template_button_click_16_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
      ...
      _createClass(EditComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.paramMap.subscribe(function () {
            ...
            _this.blogService.getPost(_this.username, parseInt(id)).subscribe(function (post) {
              _this.draft = post;
            });
          });
        }
        ...
        value: function getCurrentDraft() {
          ...
          var resp = this.blogService.getCurrentDraft();

          if (resp === null) {
            var id = this.route.snapshot.paramMap.get('id');
            this.blogService.getPost(this.username, parseInt(id)).subscribe(function (post) {
              _this2.draft = post;
            });
          } else {
            this.draft = resp;
        ...
        value: function previewPost() {
          ...
          this.router.navigate(["/preview/".concat(this.draft.postid)]);
        }
      }, {
        key: "convertToTwoDigits",
        value: function convertToTwoDigits(num) {
          if (num < 10) {
            return "0".concat(num);
          } else {
            return "".concat(num);
        ...
        key: "formatDate",
        value: function formatDate(unixEpoch) {
          var date = new Date(unixEpoch);
          var month = date.getMonth();
          var day = date.getDate();
          var year = date.getFullYear();
          var hours = date.getHours();
          var minutes = this.convertToTwoDigits(date.getMinutes());
          var seconds = this.convertToTwoDigits(date.getSeconds());
          var ampm = hours >= 12 ? 'PM' : 'AM';
          hours = hours % 12;
          hours = hours ? hours : 12;
          return "".concat(month, "/").concat(day, "/").concat(year, " ").concat(hours, ":").concat(minutes, ":").concat(seconds, " ").concat(ampm);
        }
      }]);
    ...
    EditComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["class", "edit-wrapper", 4, "ngIf"], [1, "edit-wrapper"], [1, "edit-form"], ["for", "title"], ["id", "title", 1, "form-control", 2, "height", "40px", "width", "300px", 3, "value", "input"], ["for", "body", 2, "margin-top", "10px"], ["id", "body", 1, "form-control", 2, "height", "160px", "width", "300px", 3, "value", "input"], [1, "last-modified"], [1, "edit-button-row"], ["type", "button", 1, "btn", "btn-danger", 3, "click"], ["type", "button", 1, "btn", "btn-success", 3, "disabled", "click"], ["type", "button", 1, "btn", "btn-info", 3, "click"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _list_list_component__WEBPACK_IMPORTED_MODULE_1__["ListComponent"]],
  ...
  function srcAppListListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ListComponent_div_0_div_4_Template(rf, ctx) {
      if (rf & 1) {
        var _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 5);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_div_0_div_4_Template_div_click_0_listener() {
          ...
          return ctx_r3.setCurrentDraft(post_r2);
        });
    ...
    function ListComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_div_0_Template_button_click_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);

          var ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r5.newPost();
        });
    ...
    var ListComponent = /*#__PURE__*/function () {
      ...
      _createClass(ListComponent, [{
        ...
        value: function fetchPosts() {
          ...
          this.blogService.fetchPosts(this.username).subscribe(function (posts) {
            _this4.posts = posts;
        ...
        value: function newPost() {
          ...
          var newPID = this.posts[this.posts.length - 1].postid + 1;
          this.blogService.newPost(this.username, newPID).subscribe();
          this.blogService.getPost(this.username, newPID).subscribe(function (post) {
            _this5.posts.push(post);

            _this5.blogService.setCurrentDraft(post);
          });
          this.router.navigate(["/edit/".concat(newPID)]);
        }
      }, {
        key: "convertToTwoDigits",
        value: function convertToTwoDigits(num) {
    ...
    ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["class", "list-wrapper", 4, "ngIf"], [1, "list-wrapper"], ["type", "button", 1, "btn", "btn-primary", 3, "click"], [1, "list-component"], ["class", "list-element", 3, "click", 4, "ngFor", "ngForOf"], [1, "list-element", 3, "click"], [1, "blog-card"]],
  ...
  function srcAppPreviewPreviewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function PreviewComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PreviewComponent_div_0_Template_button_click_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);

          var ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r1.switchToEdit();
        });
    ...
    var PreviewComponent = /*#__PURE__*/function () {
      ...
      _createClass(PreviewComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.getCurrentDraft();
          this.route.paramMap.subscribe(function () {
            var id = _this6.route.snapshot.paramMap.get('id');

            _this6.blogService.getPost(_this6.username, parseInt(id)).subscribe(function (post) {
              _this6.draft = post;
            });
          });
        }
        ...
        key: "renderMarkup",
        value: function renderMarkup(input) {
        ...
        value: function switchToEdit() {
          this.router.navigate(["/edit/".concat(this.draft.postid)]);
        }
      }]);
    ...
    PreviewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["class", "preview-wrapper", 4, "ngIf"], [1, "preview-wrapper"], [1, "preview-form"], ["type", "button", 1, "btn", "btn-warning", 2, "width", "100px", 3, "click"], [1, "preview-content"], [3, "innerHTML"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _list_list_component__WEBPACK_IMPORTED_MODULE_5__["ListComponent"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/cs144/shared/CS-144/project_4/angular-blog/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
